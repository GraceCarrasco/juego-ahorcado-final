...
def jugar_ahorcado():
    ...
    while intentos_restantes > 0:
        ...
        if len(letra_jugador) != 1 or not letra_jugador.isalpha():  # len() devuelve la longitud o el número de elementos de un objeto y .isalpha() es un método de las cadenas de texto que devuelve un valor booleano (True o False). Su función es verificar si una cadena de texto contiene solo letras del alfabeto. Ignora espacios, números y símbolos.
